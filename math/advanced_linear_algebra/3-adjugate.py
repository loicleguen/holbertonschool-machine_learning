#!/usr/bin/env python3
"""Module pour calculer la matrice adjugate d'une matrice carrée."""
...
def adjugate(matrix):
    """Calcule la matrice adjugate d'une matrice donnée.

    Args:
        matrix (list of lists): La matrice d'entrée.

    Returns:
        list of lists: La matrice adjugate.
    ...
    # 5. Transposition pour obtenir la matrice adjugate
    adjugate_matrix = []
    for j in range(n):
        adjugate_row = []
        for i in range(n):
